...
-- Your user_id is 1 (BIGINT)
-- Confirmed from: SELECT id, email_hash FROM users WHERE role = 'superadmin'
...
INSERT INTO ai_memory (user_id, memory) VALUES
  ...
  (1, 'Quick Kaam Services: 1) Branding & Growth Architecture - brand identity formulation, logo curation, graphic design, and long-term business scalability strategies. 2) Digital Marketing & SEO - complete 360 digital campaign planning, organic SEO management, and targeted lead generation. 3) Content Creation & Media Production - copywriting, high-conversion content writing, social media management, and promotional video/media planning. 4) Web Solutions & Cyber Security - end-to-end website design, custom software/web deployment, and foundational web security parameters. 5) Political PR Services - localized campaign strategizing, public relations management, and target-audience communication engineering. 6) Legal Advisory & Event Planning - professional legal compliance advice alongside structural brand-event coordination.'),
